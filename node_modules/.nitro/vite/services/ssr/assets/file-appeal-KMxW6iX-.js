...
import { t as workflows } from "./workflows-CntJTiKq.js";
import { useMemo, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { AlertTriangle, ArrowLeft, ArrowRight, Check, CheckCircle2, CreditCard, FileUp, Mail, PackageCheck, ShieldAlert, Stamp } from "lucide-react";
//#region src/routes/workflows/file-appeal.tsx?tsr-split=component
var stepLabels = [
	"Start",
	"Decision",
	"Facts",
...
function FileAppeal() {
	...
	const [checks, setChecks] = useState(reviewChecks.map(() => false));
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("span", { children: [
										...
										" of ",
										stepLabels.length
									] }), /* @__PURE__ */ jsxs("span", { children: [progress, "% complete"] })]
								}),
								/* @__PURE__ */ jsx("div", {
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: stepLabels.map((label, i) => /* @__PURE__ */ jsx("span", {
							...
							children: [
								step === 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [
											...
											" ",
											/* @__PURE__ */ jsx("strong", { children: "Appeal deadlines:" }),
								...
								step === 2 && /* @__PURE__ */ jsxs(Fragment, { children: [
									...
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("strong", { children: "Tip:" }), " Include specific dates, reference numbers, and evidence. Explain why the decision should be reversed or modified."]
									})
								] }),
								...
								step === 5 && /* @__PURE__ */ jsxs(Fragment, { children: [
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: reviewChecks.map((item, i) => /* @__PURE__ */ jsxs("label", {
								...
								step === 7 && /* @__PURE__ */ jsxs(Fragment, { children: [
									/* @__PURE__ */ jsx("div", {
										className: "eyebrow",
								...
								step === 8 && /* @__PURE__ */ jsxs(Fragment, { children: [
									/* @__PURE__ */ jsx("div", {
										className: "eyebrow",
									...
									/* @__PURE__ */ jsx("div", {
										className: "mt-6 grid gap-3 sm:grid-cols-2",
										children: mailOptions.map(({ id, label, price, desc, icon: Icon }) => /* @__PURE__ */ jsx("div", {
											...
											children: /* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs("div", {
													...
													children: [/* @__PURE__ */ jsx("p", {
														...
														style: { fontFamily: "var(--font-serif)" },
														children: price
													}), mailType === id && /* @__PURE__ */ jsx(Check, {
														size: 16,
								...
								step === 9 && /* @__PURE__ */ jsxs(Fragment, { children: [
									/* @__PURE__ */ jsx("div", {
										className: "eyebrow",
										children: "9 · Checkout"
									}),
