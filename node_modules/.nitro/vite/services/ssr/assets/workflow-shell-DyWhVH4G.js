...
//#region src/domain/workflows.ts
var workflows = {
	"irs-notice": {
		id: "irs-notice",
...
//#endregion
//#region src/components/workflow-shell.tsx
var MAIL_OPTIONS = [
	{
		id: "standard",
		label: "Standard",
		...
		children: steps.map((s, i) => {
			...
			return /* @__PURE__ */ jsxs("li", {
				...
				children: [
					...
					i < steps.length - 1 && /* @__PURE__ */ jsx("span", { className: "flex-1 border-t border-dashed border-rule" })
				]
			}, s.id);
		})
	});
...
function MailOptions({ selected, onSelect }) {
	return /* @__PURE__ */ jsx("div", {
		...
		children: MAIL_OPTIONS.map((opt) => /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
					...
					children: [/* @__PURE__ */ jsx("p", {
						...
						children: opt.price
					}), selected === opt.id && /* @__PURE__ */ jsx("svg", {
...
function ReviewChecks({ items, checks, setChecks }) {
	return /* @__PURE__ */ jsx("div", {
		...
		children: items.map((item, i) => /* @__PURE__ */ jsxs("label", {
