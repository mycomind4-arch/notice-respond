...
import { a as createCase, c as buildAnalysisNarration, d as buildStrategyNarration, f as buildWalkthroughNarration, g as VoiceBadge, h as NarrationButton, i as getRepository, l as buildDeadlineNarration, m as DictationInput, n as classifyNoticeType, o as transitionStatus, r as getOwnerId, s as updateCase, t as NOTICE_TYPE_META } from "./notice-type-DGSGnlOI.js";
import { useCallback, useEffect, useMemo, useRef, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { z } from "zod";
//#region src/domain/fact.ts
var factSourceSchema = z.enum([
	"extracted",
	"user",
	"inferred"
]);
var factConfidenceSchema = z.enum([
	"high",
	"medium",
	"low"
]);
var noticeFactSchema = z.object({
	id: z.string(),
	label: z.string(),
	value: z.string(),
...
//#endregion
//#region src/domain/deadline.ts
var deadlineTypeSchema = z.enum([
	"response",
	"filing",
	"hearing",
	"payment",
...
var deadlineCertaintySchema = z.enum([
	"explicit",
	"calculated",
	"inferred",
	"ambiguous",
...
//#endregion
//#region src/platform/notice-extraction.ts
var AGENCY_PATTERNS = [
	{
...
//#endregion
//#region src/domain/strategy.ts
var strategyTypeSchema = z.enum([
	"factual_correction",
	"payment_plan",
	"dispute_full",
	"dispute_partial",
...
//#endregion
//#region src/domain/security.ts
var trustLevelSchema = z.enum([
	"system",
	"application",
	"user",
	"untrusted"
]);
var contentClassificationSchema = z.object({
...
//#endregion
//#region src/domain/contradiction.ts
var contradictionTypeSchema = z.enum([
	"date_conflict",
	"amount_conflict",
	"name_conflict",
	"address_conflict",
...
var contradictionSchema = z.object({
	id: z.string(),
...
//#endregion
//#region src/domain/missing-info.ts
var missingInfoCategorySchema = z.enum([
	"deadline",
	"identity",
	"amount",
	"date",
...
var missingInfoItemSchema = z.object({
	id: z.string(),
...
//#endregion
//#region src/domain/health.ts
var healthDimensionSchema = z.object({
	name: z.string(),
	label: z.string(),
...
//#endregion
//#region src/domain/next-action.ts
var actionPrioritySchema = z.enum([
	"critical",
	"high",
	"medium",
	"low"
...
//#endregion
//#region src/domain/quality.ts
var qualityDimensionSchema = z.object({
	name: z.string(),
	score: z.number().min(0).max(100),
	label: z.string(),
	description: z.string(),
...
var qualityReportSchema = z.object({
	id: z.string(),
	overallScore: z.number().min(0).max(100),
...
//#endregion
//#region src/domain/explainability.ts
var explanationTypeSchema = z.enum([
	"deadline",
	"strategy",
	"response",
	"fact",
...
var explanationStepSchema = z.object({
	label: z.string(),
	detail: z.string(),
...
//#endregion
//#region src/domain/versioning.ts
var responseVersionSchema = z.object({
	id: z.string(),
...
var versionedResponseSchema = z.object({
	id: z.string(),
	caseId: z.string(),
...
var correctionTypeSchema = z.enum([
	"user_correction",
	"model_error",
	"extraction_error",
	"deadline_error",
...
//#endregion
//#region src/platform/save-state.ts
...
//#endregion
//#region src/routes/workflows/analyze.tsx?tsr-split=component
...
function AnalyzeNotice() {
	...
	const [showWhyStrategy, setShowWhyStrategy] = useState(null);
	const [showWhyResponse, setShowWhyResponse] = useState(false);
	const [showWhyHealth, setShowWhyHealth] = useState(false);
	const [versionedResponse, setVersionedResponse] = useState(null);
	...
	const handleResolveContradiction = useCallback((idx, value) => {
	...
	const handleResolveMissingInfo = useCallback((idx, value) => {
			...
			/* @__PURE__ */ jsxs("main", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: "Analyze"
								}), /* @__PURE__ */ jsx(VoiceBadge, { active: true })]
							}),
							/* @__PURE__ */ jsx("h1", {
						...
						] }), /* @__PURE__ */ jsx(NarrationButton, {
							script: walkthroughNarration,
							label: "Walkthrough"
						})]
					}),
					saveStatus.state !== "idle" && /* @__PURE__ */ jsxs("div", {
						className: "mt-4 flex items-center gap-3 text-sm",
						role: "status",
						"aria-live": "polite",
						children: [
							saveStatus.state === "saving" && /* @__PURE__ */ jsxs("span", {
							...
							saveStatus.state === "saved" && /* @__PURE__ */ jsxs("span", {
							...
							saveStatus.state === "failed" && /* @__PURE__ */ jsxs("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: walkthrough.map((s) => /* @__PURE__ */ jsxs("span", {
					...
					phase === "input" && /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								securityCheck && securityCheck.detectedInjectionPatterns.length > 0 && /* @__PURE__ */ jsxs("div", {
								...
								inputValidation && inputValidation.warnings.length > 0 && securityCheck?.detectedInjectionPatterns.length === 0 && /* @__PURE__ */ jsx("div", {
					...
					phase === "analysis" && analysis && /* @__PURE__ */ jsxs("div", {
						className: "mt-8 space-y-6",
						children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("h2", {
									...
									children: [/* @__PURE__ */ jsx(NarrationButton, {
										script: analysisNarration,
										label: "Listen to summary"
									}), deadlineNarration && /* @__PURE__ */ jsx(NarrationButton, {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: analysis.health.dimensions.map((dim) => /* @__PURE__ */ jsxs("div", {
									...
									showWhyHealth && /* @__PURE__ */ jsxs("div", {
							...
							analysis.actionQueue.length > 0 && /* @__PURE__ */ jsxs("div", {
								className: "envelope-card p-5",
								children: [/* @__PURE__ */ jsx("h3", {
									...
									className: "space-y-2",
									children: analysis.actionQueue.slice(0, 5).map((action) => /* @__PURE__ */ jsxs("div", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									NOTICE_TYPE_META[analysis.classification.type]?.description && /* @__PURE__ */ jsx("p", {
										className: "mt-2 text-sm text-muted-foreground",
										children: NOTICE_TYPE_META[analysis.classification.type].description
									})
								]
							}),
							analysis.deadline.date && /* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", { children: [
											...
											}), analysis.dUntil !== null && /* @__PURE__ */ jsx("div", {
												className: "text-xs text-muted-foreground",
												children: analysis.dUntil < 0 ? `${Math.abs(analysis.dUntil)} days ago` : `${analysis.dUntil} days remaining`
											})]
										})]
									}),
									analysis.deadlineValidation.warnings.length > 0 && /* @__PURE__ */ jsx("div", {
										className: "mt-3 space-y-1",
										children: analysis.deadlineValidation.warnings.map((w, i) => /* @__PURE__ */ jsxs("p", {
											className: "text-xs text-amber-600",
											children: ["⚠ ", w]
										}, i))
									}),
									showWhyDeadline && /* @__PURE__ */ jsx("div", {
										...
										children: (() => {
											...
											return /* @__PURE__ */ jsxs(Fragment, { children: [
												...
												/* @__PURE__ */ jsx("div", {
													...
													children: exp.steps.map((step, i) => /* @__PURE__ */ jsxs("div", {
														className: "text-xs",
														children: [
															/* @__PURE__ */ jsxs("span", {
															...
															step.confidence && /* @__PURE__ */ jsxs("span", {
												...
												exp.assumptions.length > 0 && /* @__PURE__ */ jsxs("div", {
													className: "mt-2",
													children: [/* @__PURE__ */ jsx("span", {
														...
														className: "ml-4",
														children: exp.assumptions.map((a, i) => /* @__PURE__ */ jsx("li", {
							...
							contradictions.length > 0 && /* @__PURE__ */ jsxs("div", {
								className: "envelope-card p-5",
								children: [/* @__PURE__ */ jsxs("div", {
									...
									className: "space-y-3",
									children: contradictions.map((c, idx) => /* @__PURE__ */ jsxs("div", {
										...
										children: [
											/* @__PURE__ */ jsxs("div", {
												...
												children: [
													...
													c.status === "resolved" && /* @__PURE__ */ jsx("span", {
											...
											c.status === "unresolved" && c.sources.length >= 2 && /* @__PURE__ */ jsx("div", {
												...
												children: /* @__PURE__ */ jsxs("select", {
													...
													}), c.sources.map((s) => /* @__PURE__ */ jsx("option", {
														value: s.value,
														children: s.value
													}, s.sourceId))]
												})
							...
							missingItems.filter((m) => m.status === "missing").length > 0 && /* @__PURE__ */ jsxs("div", {
								className: "envelope-card p-5",
								children: [/* @__PURE__ */ jsxs("div", {
									className: "flex items-center justify-between mb-3",
									children: [/* @__PURE__ */ jsx("h3", {
									...
									children: missingItems.filter((m) => m.status === "missing").map((item, idx) => {
										...
										return /* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												item.suggestedActions.length > 0 && /* @__PURE__ */ jsxs("div", {
													className: "mt-1",
													children: [/* @__PURE__ */ jsx("span", {
														...
														className: "ml-4",
														children: item.suggestedActions.map((a, i) => /* @__PURE__ */ jsx("li", {
															className: "text-xs text-muted-foreground list-disc",
															children: a
														}, i))
													})]
							...
							analysis.extraction.facts.length > 0 && /* @__PURE__ */ jsxs("div", {
								className: "envelope-card p-5",
								children: [/* @__PURE__ */ jsx("h3", {
									className: "font-serif text-lg mb-3",
									...
									className: "space-y-2",
									children: analysis.extraction.facts.map((fact) => /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", { children: [
											...
											fact.sourceExcerpt && /* @__PURE__ */ jsxs("p", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx("h3", {
											...
											children: [analysis.readiness.score, /* @__PURE__ */ jsx("span", {
					...
					phase === "strategy" && analysis && /* @__PURE__ */ jsxs("div", {
									...
									children: /* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												strategy.reason && /* @__PURE__ */ jsx("p", {
													className: "mt-2 text-xs text-muted-foreground",
													children: strategy.reason
												}),
												strategy.risks.length > 0 && /* @__PURE__ */ jsxs("div", {
													className: "mt-2",
													children: [/* @__PURE__ */ jsx("span", {
														...
														children: strategy.risks.map((risk, i) => /* @__PURE__ */ jsxs("li", {
															className: "text-xs text-muted-foreground",
															children: ["• ", risk]
														}, i))
													})]
												}),
												strategy.prerequisites.length > 0 && /* @__PURE__ */ jsxs("div", {
													className: "mt-2",
													children: [/* @__PURE__ */ jsx("span", {
														...
														className: "mt-1 space-y-0.5",
														children: strategy.prerequisites.map((prereq, i) => /* @__PURE__ */ jsxs("li", {
															className: "text-xs text-muted-foreground",
															children: ["• ", prereq]
														}, i))
													})]
												}),
												showWhyStrategy === idx && /* @__PURE__ */ jsx("div", {
													className: "mt-3 rounded-md bg-muted/50 p-4",
													children: (() => {
					...
					phase === "draft" && draft && /* @__PURE__ */ jsxs("div", {
						className: "mt-8 space-y-6",
						children: [
							/* @__PURE__ */ jsxs("div", {
								className: "flex items-center justify-between",
							...
							versionedResponse && /* @__PURE__ */ jsxs("div", {
								className: "text-xs text-muted-foreground",
								children: [
									"Version ",
							...
							showWhyResponse && analysis && /* @__PURE__ */ jsx("div", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(DictationInput, {
									value: userObjective,
							...
							qualityReport && /* @__PURE__ */ jsxs("div", {
								className: "envelope-card p-5",
								children: [
									/* @__PURE__ */ jsxs("div", {
										className: "flex items-center justify-between mb-3",
										children: [/* @__PURE__ */ jsx("h3", {
											...
											children: [qualityReport.overallScore, /* @__PURE__ */ jsx("span", {
												className: "text-sm text-muted-foreground",
												children: "/100"
											})]
										})]
									...
									/* @__PURE__ */ jsx("div", {
										...
										children: qualityReport.dimensions.map((dim) => /* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												dim.issues.length > 0 && /* @__PURE__ */ jsx("ul", {
													className: "mt-1",
													children: dim.issues.slice(0, 2).map((issue, i) => /* @__PURE__ */ jsx("li", {
							...
							draft.unresolvedPlaceholders.length > 0 && /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("h4", {
									...
									className: "mt-2 space-y-1",
									children: draft.unresolvedPlaceholders.map((p, i) => /* @__PURE__ */ jsxs("li", {
										className: "text-xs text-amber-600",
										children: [
											"• [",
											p.placeholder,
