...
const sections = [
  ...
  { title: "How We Use Your Information", body: "Your information is used solely to provide the Immigration Mail service. We never use your documents for marketing or training AI models." },
  ...
  { title: "Contact", body: "For privacy questions, contact us at privacy@immigrationmail.app." },
];
    ...
    <div className="min-h-screen page-fade">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
        ...
        <div className="mt-6 rounded-md border border-rule/70 bg-paper-deep/40 p-4 text-sm text-muted-foreground">
          Your documents and correspondence details are sensitive. This policy explains exactly how we handle them.
        </div>
