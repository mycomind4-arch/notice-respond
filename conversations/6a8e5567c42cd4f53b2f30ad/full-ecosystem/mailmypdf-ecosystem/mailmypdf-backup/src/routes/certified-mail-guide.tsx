      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-4xl px-6 py-20 md:py-24">
          ...
          <div className="mt-6 rounded-md border border-rule/70 bg-paper-deep/60 p-4 text-sm text-foreground">
            <span className="font-semibold text-stamp">Good news:</span> MailMyPDF offers Certified Mail (tracking + signature) and Registered Mail (insured + tracking) as add-on options at checkout.
          </div>
        </div>
      </section>
