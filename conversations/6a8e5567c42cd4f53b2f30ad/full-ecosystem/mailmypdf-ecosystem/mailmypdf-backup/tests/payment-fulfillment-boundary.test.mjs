...
test("Lob submission is idempotent and restricted to paid or retryable states", async () => {
  ...
  // (the refactored lob.server.ts delegates to this function instead of inlining the strings)
