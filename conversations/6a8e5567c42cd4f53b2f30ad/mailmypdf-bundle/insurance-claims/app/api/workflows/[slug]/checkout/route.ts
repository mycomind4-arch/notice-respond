...
import { getInsuranceWorkflowConfig, calculateInsurancePricing } from '@/src/domain/workflow-engine'
...
export async function POST(req: NextRequest, { params }: { params: { slug: string } }) {
  try {
    ...
    const pricing = calculateInsurancePricing(config, supportingSheets, mailingMethod)
