...
import { getBenefitsWorkflowConfig, calculateBenefitsPricing } from '@/src/domain/workflow-engine'
...
export async function POST(req: NextRequest, { params }: { params: { slug: string } }) {
  try {
    ...
    const pricing = calculateBenefitsPricing(config, supportingSheets, mailingMethod)
