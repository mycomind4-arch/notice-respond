        ...
        <div style={{
          ...
          <div>
            <div style={{display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12}}>
              ...
              <strong style={{fontSize: 15, color: '#f8fafc'}}>Benefits Appeal</strong>
          ...
          <div>
            ...
            <ul style={{listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 6}}>
              ...
              <li><a href={ECOSYSTEM_PAGE_URL} style={{fontSize: 13, color: '#a78bfa', fontWeight: 600}}>Explore all products →</a></li>
            </ul>
          </div>
        </div>
        <div style={{
          ...
          <span>Benefits Appeal is not a law firm and does not provide legal advice.</span>
        </div>
      </div>
    </footer>
  )
