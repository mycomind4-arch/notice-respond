...
const THIS_PRODUCT = 'Debt Defense'
        ...
        <div style={{
          ...
          <div>
            <div style={{display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12}}>
              <span style={{
                ...
                background: '#f87171', color: '#0a0f1a',
                fontSize: 13, fontWeight: 800,
              }}>D</span>
              <strong style={{fontSize: 15, color: '#f8fafc'}}>Debt Defense</strong>
          ...
          <div>
            ...
            <ul style={{listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: 6}}>
              ...
              <li><a href={ECOSYSTEM_PAGE_URL} style={{fontSize: 13, color: '#f87171', fontWeight: 600}}>Explore all products →</a></li>
            </ul>
          </div>
        </div>
        <div style={{
          ...
          <span>Debt Defense is not a law firm and does not provide legal advice.</span>
        </div>
      </div>
    </footer>
  )
