    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
          ...
          {templates.map((tmpl) => (
            ...
            >
              <div className="flex items-start justify-between">
                <h3 className="font-serif text-xl group-hover:text-stamp transition-colors">{tmpl.title}</h3>
              ...
              <span className="mt-4 inline-flex items-center gap-1 text-xs font-medium text-stamp">
                Use this template
        ...
        <div className="mt-10 text-center">
          ...
          <Link
            to="/write"
            className="mt-3 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-medium text-primary-foreground transition-transform hover:-translate-y-0.5"
          >
            Write from scratch →
          </Link>
        </div>
