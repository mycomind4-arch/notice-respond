            ...
            {preview && (
              <div className="envelope-card p-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-stamp">{formatUSD(preview.totalCents)} total</span>
                </div>
            ...
            <div className="envelope-card p-6 space-y-4">
              ...
              {file && preview && (
                <div className="rounded-md bg-muted/30 p-4 text-sm">
                  ...
                  <div className="mt-1 flex justify-between font-medium"><span>Total</span><span className="text-stamp">{formatUSD(preview.totalCents)}</span></div>
                </div>
              )}
            </div>
