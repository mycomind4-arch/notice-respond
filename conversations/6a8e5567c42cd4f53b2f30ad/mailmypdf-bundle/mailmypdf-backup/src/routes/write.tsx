    ...
    <section>
      ...
      <div className="flex items-center justify-between">
        <p className="mt-2 text-muted-foreground">
          ...
          Need inspiration? <a href="/templates" className="text-stamp underline">Browse templates</a>.
        </p>
        <button
          type="button"
          ...
          className={`ml-4 shrink-0 rounded-full px-4 py-1.5 text-xs font-medium transition-colors ${
            props.showAI
              ...
              : "border border-stamp text-stamp hover:bg-stamp/10"
          }`}
        >
          ✦ AI Assist
        </button>
      ...
      {props.showAI && (
        <div className="mt-6 rounded-lg border border-stamp/30 bg-stamp/5 p-5">
          <div className="flex items-center gap-2">
            <h3 className="text-sm font-semibold text-stamp">✦ AI Letter Assistant</h3>
