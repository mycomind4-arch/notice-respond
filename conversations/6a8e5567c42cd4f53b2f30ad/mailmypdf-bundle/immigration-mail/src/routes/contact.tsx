...
export const Route = createFileRoute("/contact")({
  head: () => ({ meta: [
    { title: "Contact — Immigration Mail" },
    { name: "description", content: "Get in touch with the Immigration Mail team." },
  ],
    links: [{ rel: "canonical", href: "https://immigrationmail.com/contact" }],  }),
            ...
            <div className="grid gap-8 md:grid-cols-[1fr_1.5fr]">
              <div>
                <div className="envelope-card p-5">
                  <svg className="h-5 w-5 text-stamp" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 0 0 2.22 0L21 8M5 19h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2z" /></svg>
                  <h2 className="mt-3 font-serif text-lg">Email us</h2>
                  <p className="mt-1 text-sm text-muted-foreground">For general questions and support:</p>
                  <p className="mt-2 font-medium text-foreground">support@immigrationmail.app</p>
                </div>
                <div className="mt-4 envelope-card p-5">
                  <svg className="h-5 w-5 text-stamp" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6l4 2M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0z" /></svg>
                  <h2 className="mt-3 font-serif text-lg">Response time</h2>
                  <p className="mt-1 text-sm text-muted-foreground">Typically within 1–2 business days.</p>
                </div>
                <div className="mt-4 rounded-md border border-rule/70 bg-paper-deep/40 p-4 text-xs text-muted-foreground">
                  <strong>Legal questions:</strong> Immigration Mail is not a law firm and cannot provide legal advice.
                </div>
              </div>
