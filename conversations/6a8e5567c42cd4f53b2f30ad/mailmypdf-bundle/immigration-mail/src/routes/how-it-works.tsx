...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      { title: "How It Works — Immigration Mail" },
      { name: "description", content: "How Immigration Mail works: upload your document, prepare your response, and mail it with tracking and proof of delivery." },
    ],
  }),
  component: () => (
    <>
      ...
      <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
        ...
        <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
          Immigration Mail guides you through preparing, reviewing, and mailing your document — with the same process used by legal professionals.
        </p>
