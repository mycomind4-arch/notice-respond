...
function AgencyAction() {
  ...
  const llmAnalysis = useCombinedAnalysis("agency-action");
      ...
      try {
        if (llmAnalysis.llmAnalysis) {
          const r = await fetch("/api/workflows/draft", {
            ...
            body: JSON.stringify({ workflowId: "agency-action", analysis: llmAnalysis.llmAnalysis, userFacts: facts, userObjective: objective }),
          });
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-rule/60">
          ...
          <div className="relative mx-auto max-w-4xl px-4 py-14 sm:px-6 sm:py-20 md:py-28">
            <nav className="flex items-center gap-1.5 text-xs text-muted-foreground" aria-label="Breadcrumb">
              ...
              <span className="text-rule">/</span>
              <span className="text-ink-soft">Government Agency</span>
            </nav>
            <div className="postmark w-fit mt-6">Government Agency</div>
            <h1 className="mt-6 font-serif text-4xl leading-[1.1] sm:text-5xl md:text-6xl">
              Respond to your <span className="italic text-stamp">agency action</span>
            </h1>
            <p className="mt-6 max-w-2xl text-base leading-7 text-ink-soft sm:text-lg">
              A government agency took an action affecting your rights, property, or benefits. Upload the notice, understand the decision, and prepare a documented response or appeal.
            </p>
            ...
            <div className="mt-12 grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-rule/60 bg-rule/60 sm:grid-cols-4">
              <KeyFact label="Notice type" value="Agency Action" />
        ...
        <section className="border-b border-rule/60">
          <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
            ...
            <h2 className="mt-3 font-serif text-3xl leading-tight">What is an agency action notice?</h2>
            <div className="mt-6 space-y-4 text-base leading-7 text-ink-soft">
              <p>An agency action notice is a formal communication from a government body — federal, state, or local — informing you of a decision that affects your rights, property, license, or benefits. This catch-all covers notices from agencies not covered by a specific workflow: environmental agencies, labor boards, licensing boards, housing authorities, and more.</p>
              <p>Most agency actions include appeal rights under the Administrative Procedure Act or equivalent state law. You typically have 30 to 60 days to request an administrative hearing or file an appeal. Missing the deadline can make the agency's decision final and unappealable.</p>
              <p>A documented response can request a hearing, present evidence, challenge the factual basis of the decision, or propose alternatives. Responding promptly preserves your due process rights and can open the door to negotiation or reconsideration.</p>
            </div>
            <div className="mt-8 rounded-lg border border-rule/60 bg-paper-deep/30 p-5">
              ...
              <ul className="mt-3 grid gap-2 sm:grid-cols-2">
                <li className="flex items-center gap-2 text-sm text-ink-soft"><span className="text-stamp">▸</span>Agency name and contact</li>
                <li className="flex items-center gap-2 text-sm text-ink-soft"><span className="text-stamp">▸</span>Case or file number</li>
                <li className="flex items-center gap-2 text-sm text-ink-soft"><span className="text-stamp">▸</span>Type of action taken</li>
                <li className="flex items-center gap-2 text-sm text-ink-soft"><span className="text-stamp">▸</span>Legal basis or authority</li>
                <li className="flex items-center gap-2 text-sm text-ink-soft"><span className="text-stamp">▸</span>Deadline for response or appeal</li>
        ...
        <section className="border-b border-rule/60 bg-paper-deep/20">
          <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16">
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              <ProcessStep number="01" title="Upload & analyze" text="Upload the agency notice. AI extracts the agency, action type, deadline, and appeal rights — and identifies what needs your response." />
              <ProcessStep number="02" title="Review & draft" text="Add your facts, evidence, and legal arguments. Generate a formal response, appeal request, or hearing request." />
              <ProcessStep number="03" title="Mail with proof" text="Approve the exact draft. Certified mail provides proof of timely response — critical for preserving your appeal rights before the deadline." />
            </div>
          </div>
        </section>
