...
import { n as SiteFooter, r as SiteHeader, t as Route$5 } from "./_ssr/router-qGrcUNmF.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_slug-Dv59FYBj.js
var import_jsx_runtime = require_jsx_runtime();
function GuidePage() {
	const slug = Route$5.useParams().slug;
	const guide = {
...
function P({ children, className }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		className: "mt-4 text-sm leading-7 text-muted-foreground" + (className ? " " + className : ""),
		children
	});
}
