...
//#region node_modules/.nitro/vite/services/ssr/assets/file-appeal-DVY1YXUH.js
...
function FileAppeal() {
	...
	const [decisionDate, setDecisionDate] = (0, import_react.useState)("");
	...
	const [grounds, setGrounds] = (0, import_react.useState)("");
							...
							children: [
								step === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										children: "We'll help you organize the decision being appealed, state your grounds, prepare an editable draft, and move toward mailing."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											" ",
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Appeal deadlines:" }),
											" Appeals often have very short deadlines — sometimes as few as 10–30 days. Note your deadline immediately."
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								step === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "eyebrow",
										children: "1 · The decision"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										className: "mt-3 text-2xl font-bold text-slate-700",
										style: { fontFamily: "var(--font-serif)" },
										children: "What decision are you appealing?"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Upload the decision or identify the key details here."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												...
												children: "Upload decision letter"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												...
												children: "Agency / body that issued the decision *"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												className: "input-field",
												value: agencyName,
												onChange: (e) => setAgencyName(e.target.value),
												placeholder: "e.g., Social Security Administration, IRS Appeals"
											})] }),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
												className: "input-label",
												children: "Reference / case number"
											}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
												className: "input-field",
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
													className: "input-label",
													children: "Grounds for appeal"
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
													className: "input-field",
													value: grounds,
													onChange: (e) => setGrounds(e.target.value),
													placeholder: "e.g., The decision was based on incorrect information"
												})]
											})
										]
									})
								...
								step === 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Tip:" }), " Include specific dates, reference numbers, and evidence. Explain why the decision should be reversed or modified."]
									})
								] }),
								step === 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
										...
										placeholder: "Example: I want the decision reversed and my claim approved based on the evidence enclosed."
									})
								] }),
								...
								step === 6 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Attach any evidence or supporting documents for your appeal."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
								...
								step === 7 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Enter the appeal submission address from the decision letter."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "mt-6 grid gap-4 sm:grid-cols-2",
										children: [
								...
								step === 8 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "For appeals, certified mail with return receipt is strongly recommended for proof of timely submission."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-6 grid gap-3 sm:grid-cols-2",
...
//#endregion
export { FileAppeal as component };
