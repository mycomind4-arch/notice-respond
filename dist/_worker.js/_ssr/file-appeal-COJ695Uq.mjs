...
//#region node_modules/.nitro/vite/services/ssr/assets/file-appeal-COJ695Uq.js
...
function FileAppeal() {
	...
	const [appealingTo, setAppealingTo] = (0, import_react.useState)("");
	...
	const [originalDecision, setOriginalDecision] = (0, import_react.useState)("");
...
[Your Name]`;
	...
	if (done) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Success, {
		title: "Your appeal has been submitted",
		...
		children: [
			step === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Prepare an appeal letter for a denied claim, decision, or ruling and mail it with proof of delivery."
				}),
			...
			step === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					children: "Start with the decision"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UploadZone, {
					label: "Upload decision letter",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
							...
							children: "Appealing to *"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							className: "input-field",
							value: appealingTo,
							onChange: (e) => setAppealingTo(e.target.value),
							placeholder: "Agency, board, or court"
						})] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
							className: "input-label",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								className: "input-label",
								children: "Original decision (summary)"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								className: "input-field",
								value: originalDecision,
								onChange: (e) => setOriginalDecision(e.target.value),
								placeholder: "Briefly describe what was decided"
							})]
						})
					]
				})
			...
			step === 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "mt-4 font-serif text-3xl",
					children: "What facts should the appeal include?"
				}),
			...
			step === 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "mt-4 font-serif text-3xl",
					children: "What do you want the appeal to accomplish?"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
			...
			step === 6 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UploadZone, {
					...
					sublabel: "Evidence, prior filings, documentation"
				})
			] }),
			step === 7 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RecipientForm, {
					recipient,
					setRecipient,
					orgPlaceholder: appealingTo || "Organization"
				})
			] }),
			step === 8 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-muted-foreground",
					children: "For appeals, Certified mail is recommended for proof of timely filing."
				}),
