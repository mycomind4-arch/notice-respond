...
//#region node_modules/.nitro/vite/services/ssr/assets/court-summons-DCeYQEmq.js
...
function CourtSummons() {
	...
	const [summonsDate, setSummonsDate] = (0, import_react.useState)("");
	const [responseDeadline, setResponseDeadline] = (0, import_react.useState)("");
	const [plaintiff, setPlaintiff] = (0, import_react.useState)("");
	const [defendant, setDefendant] = (0, import_react.useState)("");
							...
							children: [
								step === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
										...
										children: "Respond to a court summons"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-4 leading-7 text-slate-400",
										children: "We'll help you organize the summons, confirm the case details, prepare an editable draft, and move toward mailing. Nothing is sent until you review and approve it."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											" Court summonses have strict response deadlines — often 20–30 days. Missing the deadline can result in a default judgment against you. Note your deadline immediately."
										]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "mt-6 grid gap-3 sm:grid-cols-2",
										children: [
											"Upload or identify the summons",
											"Confirm case details and facts",
								...
								step === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										...
										style: { fontFamily: "var(--font-serif)" },
										children: "Start with the summons"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Upload the summons or identify the case details here."
									}),
								...
								step === 2 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Tip:" }), " Reference specific paragraphs or claims from the complaint. State which allegations you admit, deny, or lack knowledge of."]
									})
								] }),
								step === 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Describe the outcome you want."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
										className: "input-field mt-6 min-h-40",
										value: objective,
										onChange: (e) => setObjective(e.target.value),
										placeholder: "Example: I want to file an answer denying the allegations and requesting a hearing."
									})
								] }),
								step === 4 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldAlert, {
											size: 16,
											className: "shrink-0"
										}), " Court filings have strict procedural requirements. This draft is not legal advice. Consult an attorney if you are unsure how to respond."]
									})
								] }),
								...
								step === 6 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-3 text-slate-400",
										children: "Attach any exhibits or supporting documents referenced in your response."
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
...
//#endregion
export { CourtSummons as component };
