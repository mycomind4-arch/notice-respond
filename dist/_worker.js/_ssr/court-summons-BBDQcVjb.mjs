...
//#region node_modules/.nitro/vite/services/ssr/assets/court-summons-BBDQcVjb.js
...
[Your Name]`;
	...
	if (done) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Success, {
		title: "Your court response has been submitted",
		...
		children: [
			step === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Prepare a written response to a court summons or complaint. Nothing is sent until you review and approve it."
				}),
			...
			step === 6 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-muted-foreground",
					children: "Attach any documents referenced in your response."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UploadZone, {
					label: "Add attachments",
					sublabel: "Evidence, affidavits, exhibits"
				})
			] }),
			step === 7 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-muted-foreground",
					children: "Enter the court's mailing address."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RecipientForm, {
					recipient,
					setRecipient,
					orgPlaceholder: courtName || "Court name"
				})
			] }),
			step === 8 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-muted-foreground",
					children: "For court filings, Certified mail is recommended for proof of timely filing."
				}),
