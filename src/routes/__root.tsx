...
import { Home, ArrowRight, FileCheck } from "lucide-react";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Guided workflows to prepare, review, send, and track responses to IRS notices, court summonses, agency actions, and appeals. Physical mail with proof of delivery. Not a law firm — you control the facts." },
      ...
      { name: "twitter:title", content: "Notice Respond — Prepare and send responses to government notices" },
    ...
    <main className="min-h-screen bg-cream">
      ...
      <section className="py-20 md:py-32">
        <div className="container max-w-lg text-center">
          ...
          <h1 className="mt-8 text-6xl font-bold text-slate-700" style={{ fontFamily: "var(--font-serif)" }}>404</h1>
          <h2 className="mt-2 text-xl font-semibold text-slate-500">This page must have been filed elsewhere</h2>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Link to="/workflows/irs-notice" className="btn-emerald">Start a workflow <ArrowRight size={16} /></Link>
          </div>
        </div>
      </section>
      <SiteFooter />
