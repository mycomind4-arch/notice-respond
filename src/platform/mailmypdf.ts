/**
 * Server-only MailMyPDF platform adapter for Notice Respond.
 * Notice Respond is a separate product that consumes MailMyPDF's v1 API
 * for physical mailing services.
 */
...
export interface CreateNoticeCommunicationInput {
  document_id: string;
